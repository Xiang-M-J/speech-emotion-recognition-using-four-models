...
class LSTMNet(nn.Module):
    def __init__(self, feature_dim=39, drop_rate=0.2, num_class=7):  # input [batch_size, time_step, feature_dim]
        ...
        self.lstm = nn.LSTM(input_size=feature_dim, hidden_size=256, num_layers=2, dropout=drop_rate,
                            batch_first=True, bidirectional=True)  # output [batch_size, time_step, feature_dim]
        ...
        self.fc1 = nn.Linear(2 * 256, num_class)
